        ...
        <div class="auth__brand-inner">
          ...
          <div class="auth__brand-copy">
            ...
            <h2 class="auth__headline">
              Rejoignez
              <span class="auth__headline-grad">iSpaceCoin</span>
            </h2>
            <p class="auth__sub">
              Créez votre compte pour accéder aux marchés, actualités et portefeuille.
            </p>
      ...
      <main class="auth__panel">
        <div class="auth__panel-inner">
          <header class="auth__head">
            ...
            <p class="auth__lead">
              Inscrivez-vous pour accéder à votre espace iSpaceCoin.
            </p>
          </header>
          ...
          <form class="auth__form" @submit.prevent="submit">
            <div class="auth__field" :class="{ 'is-filled': form.name, 'is-error': form.errors.name }">
              <input
                id="reg-name"
                v-model="form.name"
                type="text"
                ...
                class="auth__input"
              />
              <label for="reg-name" class="auth__label">Nom</label>
              <p v-if="form.errors.name" class="auth__error">{{ form.errors.name }}</p>
            </div>
            ...
            <div class="auth__field" :class="{ 'is-filled': form.email, 'is-error': form.errors.email }">
              <input
                ...
                class="auth__input"
              />
              <label for="reg-email" class="auth__label">Adresse email</label>
            ...
            <div class="auth__field" :class="{ 'is-filled': form.password, 'is-error': form.errors.password }">
              ...
              />
              <label for="reg-password" class="auth__label">Mot de passe</label>
              <button
                type="button"
                class="auth__eye"
            ...
            <div
              class="auth__field"
              :class="{ 'is-filled': form.password_confirmation, 'is-error': form.errors.password_confirmation }"
            >
              <input
                ...
                class="auth__input auth__input--pw"
              />
              <label for="reg-password-confirm" class="auth__label">Confirmer le mot de passe</label>
              <button
                type="button"
                class="auth__eye"
              ...
              <p v-if="form.errors.password_confirmation" class="auth__error">
          ...
          <p class="auth__foot-link">
            Déjà un compte ?
            <Link :href="route('login')" class="auth__foot-link-a">Se connecter</Link>
          </p>
        </div>
      </main>
    </div>
